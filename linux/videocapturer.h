...
#ifndef WEBRTC_EXAMPLES_VOIP_LINUX_VIDEO_CAPTURER_H_
#define WEBRTC_EXAMPLES_VOIP_LINUX_VIDEO_CAPTURER_H_
...
class VideoCaptureV4L2 : public cricket::VideoCapturer {
 public:
  VideoCaptureV4L2();
  ~VideoCaptureV4L2();
